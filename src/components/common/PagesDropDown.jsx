...
const PagesDropdown = () => {
  return (
    <div className="relative group">
      <Link to="/pages" className="flex items-center gap-2 text-[#0000008c] hover:text-primary transition-all duration-200">
        Pages <FaChevronDown />
      </Link>
      <div className="hidden absolute bg-hover py-4 h-[185px] w-44 group-hover:block ">
        ...
        <Link to="volunteer" className="block px-2 py-1 text-gray-800 hover:bg-opacity-15 hover:bg-primary hover:text-primary">Volunteers</Link>
